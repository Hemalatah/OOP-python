...
How_I_Met_Your_Mother = media.Movie("How I Met Your Mother", 
...
Silicon_Valley = media.Movie("Silicon Valley", 
							 "In the high-tech gold rush of modern Silicon Valley, A comedy inspired by Mike Judge's experiences as a Silicon Valley engineer in the late 1980s.", 
							 "images/Silicon_Valley.jpg", 
							 "https://www.youtube.com/watch?v=69V__a49xtw")

Like_Stars_on_Earth = media.Movie("Like Stars on Earth", 
								  "An eight-year-old boy is thought to be lazy trouble-maker, until the new art teacher discover the real problem behind his struggles in school.", 
